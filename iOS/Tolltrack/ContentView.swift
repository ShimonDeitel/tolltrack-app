...
struct ContentView: View {
    @EnvironmentObject var store: TolltrackStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: TolltrackEntry?
    ...
    private func entryRow(_ entry: TolltrackEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: TolltrackEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Toll" : "Edit Toll")
